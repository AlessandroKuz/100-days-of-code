...
2.  Fork this repo and commit to the [Log](log.md) or to the Alternative, rapid R1 Log (R1 stands for Round 1) daily. [Example](https://github.com/Kallaway/100-days-kallaway-log).
